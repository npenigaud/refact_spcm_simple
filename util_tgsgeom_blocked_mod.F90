...
LOGICAL :: LGAW, LGECLO, LGELAM, LGELAT, LGEMU, LGESLO, LGEXCO, LGEYCO, LGEZCO, LGM
LOGICAL :: LGMAPPA, LGNORDL, LGNORDLCL, LGNORDM, LGNORDMCL, LGNORDMCM, LGOMVRL, LGOMVRM, LGSQM2, LNGPLAT
LOGICAL :: LNUNIQUEGP, LRCORI, LRCORIC
...
IF (LGEXCO) THEN
  ...
  !$acc exit data delete (YD%GEXCO)
ENDIF

LGEYCO = ASSOCIATED (YD%GEYCO)
IF (LGEYCO) THEN
  !$acc exit data detach (YD%GEYCO)
  !$acc exit data delete (YD%GEYCO)
ENDIF

LGEZCO = ASSOCIATED (YD%GEZCO)
IF (LGEZCO) THEN
  !$acc exit data detach (YD%GEZCO)
  !$acc exit data delete (YD%GEZCO)
ENDIF
