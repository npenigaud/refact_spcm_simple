...
CALL PCRC (__FILE__, __LINE__, PSPSP , "PSPSP ")
CALL PCRC (__FILE__, __LINE__, PSPVOR, "PSPVOR")
CALL PCRC (__FILE__, __LINE__, PSPDIV, "PSPDIV")
CALL PCRC (__FILE__, __LINE__, PSPT  , "PSPT  ")
CALL PCRC (__FILE__, __LINE__, PSPSPD, "PSPSPD")
CALL PCRC (__FILE__, __LINE__, PSPSVD, "PSPSVD")
...
WRITE (55, *) __FILE__, ':', __LINE__ 
WRITE (55, '(E30.20)') PSPT (1, 5661)
...
CALL PCRC (__FILE__, __LINE__, ZSPVORG, "ZSPVORG")
CALL PCRC (__FILE__, __LINE__, ZSPDIVG, "ZSPDIVG")
CALL PCRC (__FILE__, __LINE__, ZSPTG  , "ZSPTG  ")
CALL PCRC (__FILE__, __LINE__, ZSPSPDG, "ZSPSPDG")
DO JLEV = 1, NFLEVG
  WRITE (55, *) JLEV
  CALL PCRC (__FILE__, __LINE__, ZSPSPDG (JLEV, :), "ZSPSPDG")
ENDDO
CALL PCRC (__FILE__, __LINE__, ZSPSVDG, "ZSPSVDG")
CALL PCRC (__FILE__, __LINE__, ZSPSPG , "ZSPSPG ")
...
DO JLEV = 1, NFLEVG
  WRITE (55, *) JLEV
  CALL PCRC (__FILE__, __LINE__, ZSPDIVG (JLEV, :), "ZSPDIVG")
ENDDO
CALL PCRC (__FILE__, __LINE__, ZSPTG  , "ZSPTG  ")
CALL PCRC (__FILE__, __LINE__, ZSPSPDG, "ZSPSPDG")
CALL PCRC (__FILE__, __LINE__, ZSPSVDG, "ZSPSVDG")
