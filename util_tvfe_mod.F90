...
LOGICAL :: LRDERI, LRINTBF00, LRINTBF11, LRINTE, LRINTE_I, LRINTE_K, LRINTGW, LVFE_KNOT
...
ENDIF
LRINTE_K = ALLOCATED (YD%RINTE_K)
WRITE (KLUN) LRINTE_K
IF (LRINTE_K) THEN
  WRITE (KLUN) LBOUND (YD%RINTE_K)
  WRITE (KLUN) UBOUND (YD%RINTE_K)
  WRITE (KLUN) YD%RINTE_K
ENDIF
LRINTE_I = ALLOCATED (YD%RINTE_I)
WRITE (KLUN) LRINTE_I
IF (LRINTE_I) THEN
  WRITE (KLUN) LBOUND (YD%RINTE_I)
  WRITE (KLUN) UBOUND (YD%RINTE_I)
  WRITE (KLUN) YD%RINTE_I
ENDIF
END SUBROUTINE
...
IF (LRINTE_K) THEN
  READ (KLUN) IL2
  READ (KLUN) IU2
  ALLOCATE (YD%RINTE_K (IL2(1):IU2(1), IL2(2):IU2(2)))
  READ (KLUN) YD%RINTE_K
ENDIF
READ (KLUN) LRINTE_I
IF (LRINTE_I) THEN
  READ (KLUN) IL1
  READ (KLUN) IU1
  ALLOCATE (YD%RINTE_I (IL1(1):IU1(1)))
  READ (KLUN) YD%RINTE_I
ENDIF
END SUBROUTINE
...
LRINTE_K = ALLOCATED (YD%RINTE_K)
IF (LRINTE_K) THEN
  !$acc enter data create (YD%RINTE_K)
  !$acc update device (YD%RINTE_K)
  !$acc enter data attach (YD%RINTE_K)
ENDIF

LRINTE_I = ALLOCATED (YD%RINTE_I)
IF (LRINTE_I) THEN
  !$acc enter data create (YD%RINTE_I)
  !$acc update device (YD%RINTE_I)
  !$acc enter data attach (YD%RINTE_I)
ENDIF
...
LRINTE_K = ALLOCATED (YD%RINTE_K)
IF (LRINTE_K) THEN
  !$acc exit data detach (YD%RINTE_K)
  !$acc exit data delete (YD%RINTE_K)
ENDIF

LRINTE_I = ALLOCATED (YD%RINTE_I)
IF (LRINTE_I) THEN
  !$acc exit data detach (YD%RINTE_I)
  !$acc exit data delete (YD%RINTE_I)
ENDIF
