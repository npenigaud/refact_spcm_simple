...
LOGICAL :: LLVERBOSE, LLWRITEGRIB1, LLWRITETEXT1, LLWRITEGRIB2, LLWRITETEXT2, LLSTAT
...
IF (LLSTAT) THEN
  CALL STAT ('PSPT',   PSPT,   ZSPT  )
  CALL STAT ('PSPVOR', PSPVOR, ZSPVOR)
  CALL STAT ('PSPDIV', PSPDIV, ZSPDIV)
  CALL STAT ('PSPSPD', PSPSPD, ZSPSPD)
  CALL STAT ('PSPSVD', PSPSVD, ZSPSVD)
ENDIF
...
SUBROUTINE STAT (CDNAME, PSPL1, PSPL2)
