#if defined(_OPENACC)
SUBROUTINE TRSTOM(YDGEOMETRY,ldnhdyn,ldnhx,zbufrecv,zbufsend,PSPVORG,PSPDIVG,PSPTG,PSPSPDG,PSPSVDG,PSPSNHXG, &
...
#if defined(_OPENACC)
CALL EXCHANGE_MS (YDGEOMETRY, YLLIST, zbufsend,zbufrecv,KDIR=NEXCHANGE_STOM, LDFULLM=LDFULLM)
#else
