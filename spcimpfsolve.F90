...
!! a remettre apres passage tableaux
!!CALL TRSTOM(YDGEOMETRY,LDNHDYN,LDNHX,PSPDIVG=PSDIVP,PSPDIV=ZSDIVP,LDFULLM=LDONEM)
...
!!a remettre apres passage tableaux
!!CALL TRMTOS(YDGEOMETRY,LDNHDYN,LDNHX,PSPDIV=ZSPDIVP,PSPDIVG=PSPDIVP,LDFULLM=LDONEM)  
